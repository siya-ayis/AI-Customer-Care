...
# FIX: Changed prefix from "/call_intelligence" to "/call-intelligence" for URL consistency
app.include_router(call_analysis.router, prefix="/call-intelligence", tags=["Call Intelligence via NLP"]) 
